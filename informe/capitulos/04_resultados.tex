...
La ejecución de \texttt{make check} finalizó correctamente. Se compilaron el
monitor y los tres simuladores, y las pruebas unitarias de detección y respuesta
informaron \texttt{OK}. También se validó la sintaxis de los scripts y la
política de contención: el modo predeterminado no envía señales, las alertas no
críticas o no accionables se rechazan, PID~1 queda excluido y la identidad se
revalida antes de una respuesta. Esta verificación confirma el funcionamiento
esperado del código, pero no sustituye las mediciones experimentales en las VM.
